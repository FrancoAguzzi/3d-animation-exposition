    ...
    <div className="page">
      <main className="main">
        <div className="container">
          <Atropos className="avatar-size">
            <div className="avatar-size avatar-container">
              <div className="avatar-adornment"></div>
              <svg
                viewBox="0 0 720 720"
                fill="currentColor"
              ...
              >
                // The "data-atropos-offset" is what controls the element
                movemenet effect
                ...
                <g>
                  <path
                    ...
                    // The "data-atropos-offset" is what controls the element movemenet effect
